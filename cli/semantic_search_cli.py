...
def main() -> None:
    ...
    chunked_search_parser = subparsers.add_parser(
        "search_chunked", help="Search using chunk-level semantic search"
    )
    ...
    match args.command:
        ...
        case "search_chunked":
            ...
            engine.load_or_create_chunk_embeddings(movies)
            results = engine.search_chunks(args.query, args.limit)
